...
*   📌 **SMIa (Sociomatriz Integrada Ampliada / Abstraída):** Es un **"reflejo simplificado" (sin considerar el orden jerárquico de elección)** de la matriz SMIb, donde la codificación ordenada de 4 vías se despoja del ranking jerárquico ($1^\circ, 2^\circ, 3^\circ, \dots$) y se abstrae para convertirse directamente en una de las **81 figuras relacionales sociométricas diádicas** del tensor $Q_{81}$ ($3 \times 3 \times 3 \times 3$). Mientras SMIb retiene la intensidad ordinal fina, SMIa ofrece la tipificación categórica pura de la figura socioafectiva.
